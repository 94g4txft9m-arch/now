...
- API kód: [`main.py`](main.py) (endpointy pod `/api/*`; na Verceli natívny FastAPI bez Mangum).
- Lokálne: `npm run dev:api` alebo `python3 main.py` → [http://127.0.0.1:8000](http://127.0.0.1:8000), OpenAPI: `/api/docs`.
